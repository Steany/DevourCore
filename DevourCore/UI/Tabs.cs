...
namespace DevourCore
{
    public class Tabs
    {
        ...
        public void SetOptimizeVisible(bool visible)
        {
            prefShowOptimize.Value = visible;
            prefs.SaveToFile(false);
        }

        public void SetHSVVisible(bool visible)
        {
            prefShowHSV.Value = visible;
            prefs.SaveToFile(false);
        }

        public void SetSpeedrunVisible(bool visible)
        {
            prefShowSpeedrun.Value = visible;
            prefs.SaveToFile(false);
        }

        public void SetFOVVisible(bool visible)
        {
            prefShowFOV.Value = visible;
            prefs.SaveToFile(false);
        }

        public void SetAnticheatVisible(bool visible)
        {
            prefShowAnticheat.Value = visible;
            prefs.SaveToFile(false);
        }

        public void SetMenuVisible(bool visible)
        {
            prefShowMenu.Value = visible;
            prefs.SaveToFile(false);
        }
        ...
        public void DrawVisibilityUI(ref int selectedTab, GUIStyle headerStyle, GUIStyle descriptionStyle, GUIStyle checkboxStyle, GUIStyle labelStyle, Color themeColor, GUIStyle tabActiveStyle, GUIStyle tabInactiveStyle, GUIStyle tabTitleStyle)
        {
            GUILayout.Space(20);
            DrawHeader("Visible Categories", headerStyle, themeColor);
            GUILayout.Label("Choose which tabs to show in the client", descriptionStyle);
            GUILayout.Space(15);

            GUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();

            if (DrawToggleButton("Optimize", ShowOptimize, tabInactiveStyle, tabTitleStyle))
            {
            ...
            if (DrawToggleButton("HSV", ShowHSV, tabInactiveStyle, tabTitleStyle))
            {
            ...
            if (DrawToggleButton("Speedrun", ShowSpeedrun, tabInactiveStyle, tabTitleStyle))
            {
            ...
            if (DrawToggleButton("FOV", ShowFOV, tabInactiveStyle, tabTitleStyle))
            {
            ...
            if (DrawToggleButton("Anticheat", ShowAnticheat, tabInactiveStyle, tabTitleStyle))
            {
            ...
            if (DrawToggleButton("Menu", ShowMenu, tabInactiveStyle, tabTitleStyle))
            {
        ...
        private bool DrawToggleButton(string label, bool isOn, GUIStyle buttonStyle, GUIStyle textStyle)
        {
            ...
            bool clicked = GUILayout.Button(GUIContent.none, buttonStyle, GUILayout.Width(BUTTON_WIDTH), GUILayout.Height(24));
