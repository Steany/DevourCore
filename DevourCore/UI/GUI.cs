				...
				switch (currentHudSubMenu)
				{
					case HudSubMenu.FPS:
						if (hudManager != null)
						{
							...
							bool newShowInMenu = DrawCustomToggle(hudManager.FpsShowInMenu, Loc.GUI.Toggle_ShowInMenu);
							if (newShowInMenu != hudManager.FpsShowInMenu) hudManager.FpsShowInMenu = newShowInMenu;
					...
					case HudSubMenu.CPS:
						if (hudManager != null)
						{
							...
							bool newShowInMenu = DrawCustomToggle(hudManager.CpsShowInMenu, Loc.GUI.Toggle_ShowInMenu);
							if (newShowInMenu != hudManager.CpsShowInMenu) hudManager.CpsShowInMenu = newShowInMenu;
