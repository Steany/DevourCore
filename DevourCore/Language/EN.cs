...
<b><color={WARN}>Note:</color></b> While you are in a lobby, background selection buttons remain visible but cannot be changed until you return to the main menu. The camera may also briefly bug when starting a game or joining a lobby.
