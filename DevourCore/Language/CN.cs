...
namespace DevourCore
{
	public static class CN
	{
		public static class GUI
		{
			...
			public const string LanguageLabel = "语言: 中文 (CN)";
			...
			public const string HueFormat = "色相: {0}°";
			public const string HudOpacityFormat = "不透明度：{0}%";
			public const string Toggle_HudChroma = "彩虹";
			public const string UnknownSymbol = "?";

			public const string Tab_Gameplay = "游戏";
			public const string Tab_HUD = "界面显示";

			public const string Slider_H = "H";
			public const string Slider_S = "S";
			public const string Slider_V = "V";

			public const string Header_LookBack = "回头";
			public const string Toggle_EnableLookBack = "启用回头";
			public const string Toggle_LookBackToggleMode = "切换模式";
			public const string LookBackKeyFormat = "回头键: {0}";
			public const string LookBackNotAvailable = "回头功能不可用。";

			public const string Header_Audio = "音频";
			public const string Toggle_MuteCarnivalClock = "静音嘉年华时钟音效";

			public const string Header_HUD = "界面显示";
			public const string Button_Back = "返回";
			public const string Hud_EnableFps = "显示 FPS";
			public const string Hud_ShowInMenu = "在菜单中显示";
			public const string Hud_HidePrefix = "隐藏前缀";
			public const string Hud_InvertPrefix = "反转前缀";
			public const string Hud_UppercasePrefix = "前缀大写";
			public const string Hud_EnableCps = "显示 CPS";
			public const string Hud_DualCps = "双 CPS";
			public const string Hud_BindAFormat = "绑定 A: {0}";
			public const string Hud_BindBFormat = "绑定 B: {0}";
			public const string Hud_ShowCoordinates = "显示坐标";
			public const string Hud_ShowPrefix = "显示前缀";
			public const string Hud_VerticalPosition = "垂直位置";
			public const string Hud_ShowEnrageStatus = "显示狂暴状态";
			public const string Hud_NoBackground = "无背景";
			public const string Hud_EnableSpeedDetector = "启用速度检测";
			public const string Hud_WarningDurationFormat = "警告持续时间: {0:0.0} 秒";
			public const string Hud_AlertsFormat = "警报: {0} | 跟踪: {1}";
			public const string Hud_ClearAlerts = "清除警报";
			public const string Hud_ClearAlertsCountFormat = "清除警报 ({0})";
			public const string Hud_ShowGameTime = "显示游戏时间";
			public const string Hud_ShowLeadingMinutes = "分钟前补零";
			public const string Hud_ShowDecimals = "显示小数";
			public const string Hud_DecimalsAmountFormat = "小数位数: {0}";
			public const string Hud_FpsCounter = "FPS 计数器";
			public const string Hud_CpsCounter = "CPS 计数器";
			public const string Hud_Coordinates = "坐标";
			public const string Hud_EnrageStatus = "狂暴状态";
			public const string Hud_SpeedDetector = "速度检测";
			public const string Hud_GameTime = "游戏时间";
			public const string Hud_Size = "界面显示 大小";
			public const string Hud_SavePositions = "保存位置";
			public const string Hud_EditPositions = "编辑位置";
			public const string Hud_ResetPositions = "重置位置";

			public const string Header_Appearence = "外观";
			public const string BackgroundOpacityFormat = "背景透明度: {0}%";
			public const string Toggle_DefaultBackground = "默认背景";
			public const string Toggle_ChromaMode = "彩虹模式";
			public const string Button_CustomizeAppearence = "自定义外观";
			public const string Toggle_ClickSounds = "点击音效";
			public const string Toggle_ButtonShadow = "按钮阴影";

			public const string Stun_Calm = "冷静";
			public const string Stun_Enraged = "狂暴";
			public const string Stun_RedEyes = "红眼";
			...
			public const string WelcomeBodyFormat = "欢迎使用 DevourCore!\n按下 '{0}' 打开客户端。";
			public const string WelcomeButtonNext = "下一步";
			public const string HelpBody = "将鼠标悬停在界面右下角的信息图标上可查看每个类别的说明。你也可以拖动界面，将其放到你喜欢的位置。";
			public const string HelpButtonEnjoy = "玩得开心 <3";

			public const string Button_HudTextStyleFormat = "文字样式: {0}";
			public const string Button_UiTextStyleFormat = "界面文字样式: {0}";
			public const string TextStyle_Outline = "描边";
			public const string TextStyle_Shadow = "阴影";
		}
		...
		public static class Anti
		{
			...
			public const string SuspiciousPlayersTitle = "可疑玩家";
			public const string DragBoxHint = "拖动此框以设置警报位置";
...
{B}<b><color={ACCENT}>阁楼出生点:</color></b> 重新还原旧版 Farmhouse 的漏洞，使用 Anna 时会将你生成在阁楼，并且支持 <b>任何角色</b>。同时恢复旧版的门行为，这意味着在触发 Anna 之前打开的门将保持开启，而不会自动关闭。
...
<b><color={ACCENT}>外观:</color></b> 自定义客户端外观，包括标签、复选框和滑块颜色，自定义背景颜色和透明度，<b><color={ACCENT}>默认背景</color></b>、<b><color={ACCENT}>深色标签</color></b>、<b><color={ACCENT}>炫彩模式</color></b>、游戏内 <b><color={ACCENT}>点击音效</color></b>、<b><color={ACCENT}>按钮阴影</color></b>，以及在文本 <b><color={ACCENT}>描边</color></b> 或 <b><color={ACCENT}>阴影</color></b> 样式之间切换。

{B}在<b><color={ACCENT}>可见标签</color></b>中, 你可以启用或隐藏整页标签, 只保留自己关心的部分。

{B}<b><color={ACCENT}>语言</color></b>可以在在英文, 中文和葡萄牙语界面之间切换。
...
{B}<b><color={ACCENT}>视野限制绕过:</color></b> 允许将 FOV 设置到原版范围之外, 且不影响游戏内滑块数值。

{B}启用后, 过场和跳杀也会使用你的自定义 FOV。

{B}<b><color={ACCENT}>回头看:</color></b> 跑动时快速查看身后。

{B}<b><color={ACCENT}>音频:</color></b> 一些实用的静音开关 (天气, 嘉年华隧道, 嘉年华钟声等)。";

			public const string 界面显示 = @"
{B}<b><color={ACCENT}>界面显示:</color></b> 可自由拖动和摆放的屏幕信息叠加层。

{B}<b><color={ACCENT}>FPS 计数器:</color></b> 显示当前帧率。

{B}<b><color={ACCENT}>CPS 计数器:</color></b> 显示每秒点击或按键次数, 可绑定两个按键 (常用于<b>动作</b>与<b>丢弃</b>)。

{B}<b><color={ACCENT}>坐标:</color></b> 显示你在游戏中的位置。

{B}<b><color={ACCENT}>狂暴状态:</color></b> 显示 Anna 当前状态。

{B}<b><color={ACCENT}>速度检测:</color></b> 实时监控玩家平均移动速度, 数值可疑时显示短暂警告。

{B}<b><color={ACCENT}>游戏时间:</color></b> 显示本局已进行的时间。

{B}<b><color={ACCENT}>界面显示大小:</color></b> 全局缩放所有 界面显示 元素。";
			public const string HUD = @"
{B}<b><color={ACCENT}>界面显示:</color></b> 可自由拖动的屏幕信息叠加层。

{B}<b><color={ACCENT}>FPS:</color></b> 显示当前帧率。

{B}<b><color={ACCENT}>CPS:</color></b> 显示点击速度。
{B}可绑定任意两枚按键（通常是交互键和丢弃键）。

{B}<b><color={ACCENT}>坐标:</color></b> 显示 X/Y/Z 位置。

{B}<b><color={ACCENT}>狂暴状态:</color></b> 显示 Anna 当前状态。

{B}<b><color={ACCENT}>速度检测:</color></b> 实时监测平均移动速度，数值异常时短暂提示警告。

{B}<b><color={ACCENT}>计时器:</color></b> 显示本局用时。

{B}<b><color={ACCENT}>大小:</color></b> 全局缩放。
{B}<b><color={ACCENT}>编辑位置:</color></b> 拖动摆放。
{B}<b>保存位置</b> 保存布局；<b>重置位置</b> 恢复默认。";
