...
- Added **HSV** tab (666 icon color HSV, outfit HSV)
- Added **Speedrun** tab (instant interaction, attic spawn, auto start)
- Added **Custom FOV** tab
- Added **Anticheat** tab (speed cheat detection, alerts)
...
- Restored old **Attic Spawn** door behavior where locked doors opened before triggering Anna remain open once triggered
